...
TASK_ID = "TASK-1"
STEPS = json.loads('[{"before_b64": "ICAgIGlmIHRhc2tfaWRzLmZpcnN0KCkubWFwKHxzfCBzLmFzX3N0cigpKSA9PSBTb21lKCItIikgfHwgdGFza19pZHMuaXNfZW1wdHkoKSB7", "after_b64": "ICAgIGlmIHRhc2tfaWRzLmZpcnN0KCkubWFwKHxzfCBzLmFzX3N0cigpKSA9PSBTb21lKCItIikgew==", "target": "workflow-cli/src/main.rs", "index": 0, "is_create": false}]')
