#!/usr/bin/env python3
"""TASK-4: Update parse_u_values call site in main.rs to propagate the error"""
import base64, json, subprocess, sys

TASK_ID = "TASK-4"
STEPS = json.loads('[{"before_b64": "ICAgIGxldCB1X3ZhbHVlcyA9IGNvbmZpZy5wYXJzZV91X3ZhbHVlcygpOw==", "after_b64": "ICAgIGxldCB1X3ZhbHVlcyA9IGNvbmZpZy5wYXJzZV91X3ZhbHVlcygpLm1hcF9lcnIofGV8IGFueWhvdzo6YW55aG93IShlKSk/Ow==", "target": "examples/hubbard_u_sweep_slurm/src/main.rs", "index": 0}]')
