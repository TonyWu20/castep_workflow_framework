...
TASK_ID = "TASK-6"
STEPS = json.loads('[{"before_b64": "cHViIHVzZSBxdWV1ZWQ6Oio7", "after_b64": "cHViIHVzZSBxdWV1ZWQ6OntRdWV1ZWRSdW5uZXIsIFNjaGVkdWxlcktpbmR9Ow==", "target": "workflow_utils/src/lib.rs", "index": 0}]')
